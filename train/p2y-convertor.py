...
absolutepath_of_directory_with_xmlfiles = './datasets/keihin-test-4/VOC/annotations/'  #　It is okay to have a mix of xml files and images in the same directory.
absolutepath_of_directory_with_imgfiles = './datasets/keihin-test-4/VOC/images/'
absolutepath_of_directory_with_yolofiles = './datasets/keihin-test-4/YOLO/'  # Yolo files will be created under this directory.
absolutepath_of_directory_with_classes_txt = './datasets/keihin-test-4/YOLO/'  # You do not need to create classes.txt. classes.txt will be generated automatically.
absolutepath_of_directory_with_error_txt = './datasets/keihin-test-4/'  # The file names of files that do not have a paired xml or image file will be written to a text file under this directory.
