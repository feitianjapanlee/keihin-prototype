...
# cvat-cli --auth notbadboy:Admin@123 --server-host localhost --server-port 8080 task auto-annotate "2" --function-file ./auto-annotate.py
import PIL.Image
from ultralytics import YOLO
import cvat_sdk.auto_annotation as cvataa
import cvat_sdk.models as models
_model = YOLO("../models/train16/weights/best.pt")
